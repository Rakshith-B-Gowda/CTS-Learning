 ...
 * 
 * import org.aspectj.lang.annotation.AfterThrowing; import
 ...
 * @Aspect
 * 
 * @Component public class LoggingAspectAfterThrowing {
 * 
 * private final Logger LOGGER = LoggerFactory.getLogger(this.getClass());
 * 
 * @AfterThrowing(pointcut =
 * "execution(* com.example.demo.service.EmployeeService.*(..))", throwing =
